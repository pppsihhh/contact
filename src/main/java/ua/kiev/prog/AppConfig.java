    ...
    public CommandLineRunner demo(final ContactService contactService) {
        return new CommandLineRunner() {
            ...
            public void run(String... strings) throws Exception {
                ...
                Group g2 = new Group("My group");
                contactService.addGroup(g2);

                contact = new Contact(g2,"Sergey", "Boyko", "0970000000", "qqq@rrt.com");
                contactService.addContact(contact);

                contact = new Contact(g2,"Andrey", "Maslov", "0970000001", "uuu@rrt.com");
                contactService.addContact(contact);
